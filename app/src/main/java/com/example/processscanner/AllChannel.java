...
public class AllChannel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LineChart[] lineCharts = new LineChart[16];
        ...
        lineCharts[8] = view.findViewById(R.id.chart9);
        lineCharts[9] = view.findViewById(R.id.chart10);
        lineCharts[10] = view.findViewById(R.id.chart11);
        lineCharts[11] = view.findViewById(R.id.chart12);
        lineCharts[12] = view.findViewById(R.id.chart13);
        lineCharts[13] = view.findViewById(R.id.chart14);
        lineCharts[14] = view.findViewById(R.id.chart15);
        lineCharts[15] = view.findViewById(R.id.chart16);
