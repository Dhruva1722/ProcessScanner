...
public class Channel6 extends AppCompatActivity {
    ...
    private int fillColor = Color.argb(150, 255, 0, 0);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Channel6.this, MainActivity.class);
    ...
    private void setDataForBarChart() {
        ...
        barDataSet.setColors(getColor(R.color.red));
