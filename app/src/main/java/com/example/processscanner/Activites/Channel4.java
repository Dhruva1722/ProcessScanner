...
public class Channel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Channel4.this, MainActivity.class);
    ...
    private void setDataForBarChart() {
        ...
        barDataSet.setColors(getColor(R.color.blue));
    ...
    private void setData(int count, float range) {
        ...
        set1.setColor(getColor(R.color.blue));
