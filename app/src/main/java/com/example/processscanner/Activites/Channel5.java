...
public class Channel5 extends AppCompatActivity {
    ...
    private int fillColor = Color.argb(150, 128, 0, 128);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_channel5);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Channel5.this, MainActivity.class);
    ...
    private void setDataForBarChart() {
        ...
        barDataSet.setColors(getColor(R.color.purple));
    ...
    private void setData(int count, float range) {
        ...
        set1.setColor(getColor(R.color.purple));
        set1.setDrawCircles(true);
        set1.setDrawFilled(true);
        set1.setFillColor(fillColor);

        set2 = new LineDataSet(yVals1, "Data Set1");
        set2.setColor(getColor(R.color.purple));
